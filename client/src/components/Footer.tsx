        ...
        <div className="text-center">
          ...
          <div className="flex justify-center space-x-6 mb-8">
            <a 
              ...
              className="w-12 h-12 bg-accent hover:bg-accent/80 rounded-full flex items-center justify-center transition-colors duration-300"
            >
          ...
          <div className="border-t border-gray-700 pt-8">
            <p className="text-gray-400 text-sm">
              &copy; {new Date().getFullYear()} {personalInfo.firstName} {personalInfo.lastName}. Tous droits réservés.
            </p>
          </div>
        </div>
      </div>
