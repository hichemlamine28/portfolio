...
export const experiences: Experience[] = [
  ...
  },
  {
    ...
    projects: [
      ...
      {
        name: "BP-Profiling",
        description: "Plateforme de profilage et d'analyse comportementale",
        achievements: [
          "Architecture cloud sur Azure avec AKS",
      ...
      },
      {
        ...
        achievements: [
          "Déploiement sur GCP avec GKE",
          "Intégration APIs de machine learning",
      ...
      {
        name: "Crips",
        description: "Système de gestion de données critiques",
        achievements: [
          "Architecture AWS avec EKS",
          "Base de données PostgreSQL haute disponibilité",
          "Sécurisation avec Vault",
          "Tests automatisés avec Cypress"
        ]
      },
      {
        name: "BP-Erp",
        description: "Solution ERP interne pour la gestion d'entreprise",
        achievements: [
          "Architecture multi-cloud (Azure/AWS)",
          "Intégration continue avec GitLab CI",
          "Monitoring centralisé ELK",
          "Gestion des coûts cloud optimisée"
        ]
      },
      {
        name: "BP-Monitoring",
        description: "Plateforme centralisée de supervision et monitoring",
        achievements: [
          "Stack complète Grafana/Prometheus/ELK",
          "Alerting multi-canal",
          "Dashboards personnalisés par client",
          "Intégration avec tous les projets BP"
        ]
      },
      {
        name: "Smartocr",
        description: "Solution OCR intelligente pour reconnaissance de documents",
        achievements: [
          "Déploiement containerisé Docker/Kubernetes",
          "APIs REST avec rate limiting",
          "Machine Learning pipeline",
          "Storage object sur cloud"
        ]
      },
      {
        name: "Difference",
        description: "Outil de comparaison et analyse de différences",
        achievements: [
...
const calculateStats = () => {
  ...
  // Comptage des domaines de technologies basé sur les catégories de compétences
  const technologyDomains = new Set([
    'Cloud & Infrastructure', 'DevOps & Automation', 'Containers & Orchestration',
    'Monitoring & Observability', 'Security & DevSecOps', 'Atlassian Suite',
    'Agile & Management', 'Programming & Scripting', 'Databases', 'Networking & Infrastructure'
  ]);
  
  // Comptage des secteurs uniques basé sur les entreprises
  const uniqueSectors = new Set([
    'Défense/Sécurité', 'Énergie', 'Services Publics', 'Technologies', 
    'Formation', 'Conseil', 'Télécommunications', 'Finance', 'Retail', 'Éducation'
  ]);

  return [
    { value: `${calculateYearsOfExperience()}+`, label: "Années d'Expérience" },
    { value: `${totalProjects}+`, label: "Projets Réalisés" },
    { value: `${technologyDomains.size}+`, label: "Domaines de Technologies Maîtrisées" },
    { value: `${uniqueSectors.size}+`, label: "Secteurs d'Activité" }
  ];
};
